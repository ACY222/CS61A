class Transaction:
    def __init__(self, id, before, after):
        self.id = id
        self.before = before    # the account balance before the transaction
        self.after = after
    ...
    def changed(self):
        ...
        # Or return self.before != self.after
...
class Server:
    ...
    dictionary from client names to client objects(namely client instances)
    """
    def __init__(self):
        self.clients = {}
